...
# Cria a insittuicao
resp="$(curl -X POST localhost:8080/institutions -H "${auth}" -H 'Content-Type: application/json' -d '{"name":"Escolando - Good data", "email": "contato@escolinha.com", "addressStreet": "Rua São Clemente, Botafogo RJ", "addressNumber": 10000, "addressPostal": "26722-901", "owner": {"id": 1}}')"
...
# Cada pai vai mandar 100 mensagens
for ((i=0; i<100; i++)); do
